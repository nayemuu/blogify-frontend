...
const BlogCard = ({ blog }) => {
  return (
    <div className="blog-card-shadow border-2 border-transparent hover:border-brand-primary rounded-[12px] ">
      <div className="bg-[#FFFFFF] rounded-[12px] flex overflow-hidden h-[171px]">
        <div className="relative h-full aspect-[412/382] rounded-[12px] overflow-hidden shrink-0">
          <Image
            src={blog.thumbnail}
            fill
        ...
        <div className="w-full p-4 flex flex-col gap-3">
          <div className="flex justify-between w-full">
            <div className="p-[5px] text-brand-primary bg-brand-primary-soft font-normal text-[12px] leading-[14px] rounded-[4px]">
              COVID-19
            </div>
            <div>
          ...
          <div
            className={`text-[16px] font-medium leading-[18px] article-card-content blog-card-title`}
          >
            {/* {blog.title} */}
            COVID-19 Was a Top Cause of Death in 2020 and 2021, Even For Younger
            People COVID-19 Was a Top Cause of Death in 2020 and 2021, Even For
            Younger People COVID-19 Was a Top Cause of Death in 2020 and 2021,
            Even For Younger PeopleCOVID-19 Was a Top Cause of Death in 2020 and
            2021, Even For Younger PeopleCOVID-19 Was a Top Cause of Death in
            2020 and 2021, Even For Younger PeopleCOVID-19 Was a Top Cause of
            Death in 2020 and 2021, Even For Younger PeopleCOVID-19 Was a Top
            Cause of Death in 2020 and 2021, Even For Younger PeopleCOVID-19 Was
            a Top Cause of Death in 2020 and 2021, Even For Younger
            PeopleCOVID-19 Was a Top Cause of Death in 2020 and 2021, Even For
            Younger PeopleCOVID-19 Was a Top Cause of Death in 2020 and 2021,
            Even For Younger PeopleCOVID-19 Was a Top Cause of Death in 2020 and
            2021, Even For Younger PeopleCOVID-19 Was a Top Cause of Death in
            2020 and 2021, Even For Younger PeopleCOVID-19 Was a Top Cause of
            Death in 2020 and 2021, Even For Younger PeopleCOVID-19 Was a Top
            Cause of Death in 2020 and 2021, Even For Younger PeopleCOVID-19 Was
            a Top Cause of Death in 2020 and 2021, Even For Younger People
          </div>
        </div>
      </div>
    </div>
